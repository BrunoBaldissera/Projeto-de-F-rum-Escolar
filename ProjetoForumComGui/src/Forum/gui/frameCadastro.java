	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if("criar".equals(arg0.getActionCommand())) {
			if(modCheck.isSelected()) {
				...
				try {
					fStream = new FileWriter("src/usuarios.csv", true);
				} catch (IOException e) {
					e.printStackTrace();
				}
				PrintWriter out = new PrintWriter(fStream);
				out.println(nomeField.getText() + ";" + senhaField.getText() + ";" + cargoField.getText());
				out.flush();
				out.close();
				try {
					fStream.close();
				...
				PrintWriter out = new PrintWriter(fStream);
				out.println(nomeField.getText() + ";" + senhaField.getText());
				out.flush();
				out.close();
				try {
					fStream.close();
